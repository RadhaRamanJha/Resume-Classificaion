...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"C:\Users\priyanka burse\Desktop\Project_P387\Clean_resumes.csv") # reading the csv file
            
    
    skills = list(data.Resume_Details.values)# extract values
...
# MAIN CODE
import pickle as pk
model = pk.load(open(r"C:\Users\priyanka burse\Desktop\Project_P387\ModelDTC.pkl", 'rb'))
Vectorizer = pk.load(open(r"C:\Users\priyanka burse\Desktop\Project_P387\VECTOR.pkl", 'rb'))
